OC.L10N.register(
    ...
    "Belarusian" : "Belarusz",
    "Bulgarian" : "Bolgár",
    "Bihari languages" : "Bihari nyelvek",
    "Bislama" : "Biszlama",
    "Bambara" : "Bambara",
    "Bengali" : "Bengáli",
    "Tibetan" : "Tibeti",
    ...
    "Cree" : "Krí",
    "Czech" : "Cseh",
    "Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic" : "Egyházi szláv; Ószláv; Egyházi szláv; Óbolgár; Egyházi ószláv",
    "Chuvash" : "Csuvas",
    "Welsh" : "Walesi",
    "Danish" : "Dán",
    "German" : "Német",
    "Divehi; Dhivehi; Maldivian" : "Divehi; Dhivehi; Maldív",
    "Dzongkha" : "Dzsonga",
    "Ewe" : "Eve",
    "Greek, Modern (1453-)" : "Modern görög (1453-)",
    "English" : "Angol",
    "Esperanto" : "Eszperantó",
    "Spanish; Castilian" : "Spanyol; Kasztíliai",
    "Estonian" : "Észt",
    "Basque" : "Baszk",
    "Persian" : "Perzsa",
    "Fulah" : "Ful",
    ...
    "Irish" : "Ír",
    "Gaelic; Scottish Gaelic" : "Kelta; Skót gael",
    "Galician" : "Galíciai",
    "Guarani" : "Guarani",
    "Gujarati" : "Gudzsaráti",
    "Manx" : "Manx",
    ...
    "Hiri Motu" : "Hiri Motu",
    "Croatian" : "Horvát",
    "Haitian; Haitian Creole" : "Haiti; Haiti kreol",
    "Hungarian" : "Magyar",
    "Armenian" : "Örmény",
    "Herero" : "Herero",
    ...
    "Igbo" : "Igbo",
    "Sichuan Yi; Nuosu" : "Szecsuáni; Nuosu",
    "Inupiaq" : "Inupiat",
    "Ido" : "Ido",
    "Icelandic" : "Izlandi",
    "Italian" : "Olasz",
    ...
    "Kazakh" : "Kazak",
    "Kalaallisut; Greenlandic" : "Kalaallisut; Grönlandi",
    "Central Khmer" : "Khmer",
    "Kannada" : "Kannada",
    "Korean" : "Koreai",
    "Kanuri" : "Kanuri",
    ...
    "Komi" : "Komi",
    "Cornish" : "Korni",
    "Kirghiz; Kyrgyz" : "Kirgiz",
    "Latin" : "Latin",
    "Luxembourgish; Lëtzeburgesch" : "Luxemburgi",
    "Ganda" : "Ganda",
    "Limburgan; Limburger; Limburgish" : "Limburgi",
    "Lingala" : "Lingala",
    "Lao" : "Lao",
    "Lithuanian" : "Litván",
    ...
    "Maltese" : "Máltai",
    "Burmese" : "Burmai",
    "Bokmål, Norwegian; Norwegian Bokmål" : "Bokmål, norvég; Norvég bokmål",
    "Ndebele, North; North Ndebele" : "Ndebele, északi; Északi ndebele",
    "Nepali" : "Nepáli",
    "Ndonga" : "Ndonga",
    "Dutch; Flemish" : "Holland; Flamand",
    "Norwegian Nynorsk; Nynorsk, Norwegian" : "Norvég nynorsk; Nynorsk, norvég",
    "Norwegian" : "Norvég",
    "Ndebele, South; South Ndebele" : "Ndebele, déli; Déli ndebele",
    "Navajo; Navaho" : "Navahó",
    "Chichewa; Chewa; Nyanja" : "Chichewa; Chewa; Nyanja",
    "Occitan (post 1500)" : "Okszitán (1500 utáni)",
    "Ojibwa" : "Odzsibva",
    "Oromo" : "Oromó",
    "Oriya" : "Orija",
    "Ossetian; Ossetic" : "Oszét",
    "Panjabi; Punjabi" : "Pandzsábi",
    "Pali" : "Páli",
    "Polish" : "Lengyel",
    "Pushto; Pashto" : "Patu",
    "Portuguese" : "Portugál",
    ...
    "Romansh" : "Romans",
    "Rundi" : "Rundi",
    "Romanian; Moldavian; Moldovan" : "Román; Moldáv; Moldovai",
    "Russian" : "Orosz",
    ...
    "Terms of service have been modified!" : "A szolgáltatás feltételei megváltoztak!",
    "You have to accept the newest version of the terms of service in order to be able to use this service." : "Ahhoz, hogy a szolgáltatást használni tudja, el kell fogadnia a legújabb szolgáltatási feltételeket.",
    "Requires users to accept the terms of service before accessing data." : "Megköveteli a felhasználóktól, hogy az adatokhoz történő hozzáférés előtt elfogadják a szolgáltatási feltételeket.",
    "Requires users to accept the terms of service before accessing data.\nThis product includes GeoLite2 data created by MaxMind, available from [maxmind.com](http://www.maxmind.com)" : "Megköveteli a felhasználóktól, hogy az adatokhoz történő hozzáférés előtt elfogadják a szolgáltatási feltételeket.\nEz a termék a MaxMind által készített GeoLite2 adatokat tartalmazza, amely a [maxmind.com](http://www.maxmind.com) webhelyről érhető el.",
    "Loading …" : "Betöltés…",
    "Reset signatories & notify users" : "Aláíró felek visszaállítása és felhasználók értesítése",
    "Save terms" : "Feltételek mentése",
    ...
    "Require users to accept the terms of service before accessing the service." : "Megkövetelés a felhasználóktól, hogy a szolgáltatáshoz történő hozzáférés előtt elfogadják a szolgáltatási feltételeket.",
    "Show for logged-in users" : "Megjelenítés a bejelentkezett felhasználók számára",
    "Show on public shares" : "Megjelenítés a nyilvános megosztásokon",
    "Enter or update terms of service below." : "Adja meg vagy frissítse a lenti szolgáltatási feltételeket.",
    "Select a region" : "Válasszon régiót",
    "Select a language" : "Válasszon nyelvet",
    "By using this service …" : "A szolgáltatás használatával…",
    "For formatting purposes Markdown is supported." : "Formázási célokhoz a Markdown támogatott.",
    "Saving the terms will update the text but will not send a notification to users. Notifications are only sent if you reset the signatories." : "A feltételek mentése frissíti a szöveget, de nem küld értesítést a felhasználók számára. Csak akkor küld értesítéseket, ha visszaállítja az aláíró feleket.",
    "Existing terms of service" : "Jelenlegi felhasználási feltételek",
    "We recommend resetting the signatories if legal changes were applied. For minor changes like fixing typos or correcting links, it could be left out, as it would otherwise require all users to accept the Terms of Service again." : "Jogi módosítások esetén javasoljuk az aláíró felek visszaállítását. Kis változtatásoknál, mint az elírások vagy hivatkozások javítása, elhagyható, mert különben az összes felhasználónak újra el kellene fogadnia a szolgáltatási feltételeket.",
