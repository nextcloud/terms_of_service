OC.L10N.register(
    "terms_of_service",
    {
    "Terms of service are not signed" : "لم يتم التوقيع على شروط الخدمة",
    "Global" : "عالمي",
    ...
    "Guyana" : "غيانا",
    "Haiti" : "هاييتي",
    "Heard Island and McDonald Islands" : "جزيرة هيرد وجزر ماكدونالز",
    "Holy See" : "دولة الفاتيكان",
    "Honduras" : "هندوراس",
    "Hong Kong" : "هونج كونج",
    "Hungary" : "هنغاريا",
    "Iceland" : "ايسلندا",
    ...
    "Moldova (Republic of)" : "مولدافيا (جمهورية)",
    "Monaco" : "موناكو ",
    "Mongolia" : "منغوليا",
    ...
    "Vanuatu" : "فانواتو",
    "Venezuela (Bolivarian Republic of)" : "فنزويلا (جمهورية)",
    "Viet Nam" : "فييتنام",
    ...
    "Terms of service have been modified!" : "شروط الخدمة تمّ تغييرها",
    ...
    "We recommend to reset signatures if legal changes were applied. For minor changes like fixing typos or correcting links, it could be left out, as it would otherwise require all users to accept the Terms of Service again." : "نوصي بإعادة تعيين التوقيعات إذا تم تطبيق تغييرات قانونية. بالنسبة للتغييرات البسيطة مثل تصحيح الأخطاء المطبعية أو تصحيح الروابط، يمكن تركها، حيث ستتطلب بخلاف ذلك من جميع المستخدمين قبول شروط الخدمة مرة أخرى.",
    "Loading …" : "التحميل جارٍ …",
    "Reset signatories & notify users" : "إعادة تعيين المُوقِّعين و إشعار المستخدِمين",
